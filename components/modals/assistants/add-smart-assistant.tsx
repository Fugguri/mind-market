      ...
      {data.isInitialNode ? (
        <>
          <div>
            ...
            <label>
              Название компании:
              <Textarea  value={companyName} onChange={(e) => handleChange('companyName', e.target.value)} />
            </label>
          </div>
          <div>
            <label>
          ...
          <div>
            <label>
              ...
              <Textarea  value={assistantGoal} onChange={(e) => handleChange('assistantGoal', e.target.value)} />
            </label>
          </div>
        </>
      ) : (
        <>
          ...
          <div>
            <label>
              ...
              <Textarea  value={assistantAction} onChange={(e) => handleChange('assistantAction', e.target.value)}  />
...
const DecisionTree: NextPage = () => {
    ...
    const isModalOpen = isOpen && type === 'addSmartAssistant';
