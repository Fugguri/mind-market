	...
	return (
		<div className='grid grid-cols-6 w-full '>
			<div className='col-end-6'>
				<ActionTooltip side='right' align='end' label='Добавить диалог'>
					<button onClick={onClick} className='group flex items-left'>
						<div
							className='col-span-end flex mx-3 h-[25px] w-[180px]
