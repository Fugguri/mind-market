...
import { Card, CardQuote } from "../../components/cards";
...
export default function ContactsPage() {
  return (
    <>
      <BlockLTRCenter>
        <LargeHeading text="Наши контакты" />
        {/* <Card
          label=""
          text="Рады предоставить дополнительную информацию о платформе MindMarket и ответить на ваши вопросы. Не стесняйтесь связаться с нами по любым вопросам, связанным с нашей платформой и технологиями искусственного интеллекта."
        /> */}
      </BlockLTRCenter>
      ...
      <div className={styles.middleContainer}>
        ...
        <CardQuote text="Мы находимся здесь, чтобы помочь вам раскрыть потенциал искусственного интеллекта для вашего бизнеса. Не стесняйтесь задавать вопросы, предлагать идеи и обсуждать возможности с нами." />
      </div>
