const PrivacyPolicyPage = () => {
	return (
		<div>
			...
			<p>Last updated: October 28, 2023</p>
			<p>
			...
			<ul>
				...
				<li>
					<p>
						...
						'Our' in this Agreement) refers to MindMarket.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<b>Website</b> refers to MindMarket, accessible from{' '}
						<a
							href='https://web-mindmarket.ru'
							rel='external nofollow noopener'
							target='_blank'
						>
							https://web-mindmarket.ru
						</a>
					</p>
				</li>
				<li>
			...
			<p>
				...
				third party's site. We bly advise You to review the Privacy Policy of
			...
			<ul>
				<li>By email: fygguri@icloud.com</li>
			</ul>
		</div>
	)
}
